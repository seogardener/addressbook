...
var Show = {
	...
	b_test : function(){
		...
		//contents	+= '</tbody></table><script type="text/javascript"> opener.Common.tblRollOver(document.getElementById("errmsgs")); </script></BODY></HTML>';
	...
	theChangedAvatar : function( img ) {
		...
		console.log(img + " / " + idphoto.src + " / " + GVari.addr.photo );
	},
